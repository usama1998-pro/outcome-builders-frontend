                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <span className="font-medium">Brainspaces</span>
                            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="p-5 rounded-xl bg-gradient-to-br from-violet-500/5 to-purple-500/5 border border-violet-500/10">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="font-semibold mb-1">Organize with Brainspaces</h3>
                                    <p className="text-sm text-muted-foreground">
                                        Create brainspaces to organize your team&apos;s knowledge and collaborate effectively.
                                    </p>
                                </div>
                            </div>
                        </div>

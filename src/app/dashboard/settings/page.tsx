            ...
            <div className="w-full h-full flex flex-col items-center p-6 gap-6">
                ...
                <div className="w-full border-b-2 border-dashed pb-4">
                    <h1 className="text-3xl font-bold flex items-center gap-2">
                        <Shield className="h-7 w-7 text-[#DB2B30]" />
                        Settings
                    </h1>
                ...
                <div className="w-full max-w-4xl space-y-6">
                    {/* Security Settings */}
                    <Card className="border border-[#DB2B30]/40">
                        <CardHeader>
                            <CardTitle className="flex items-center gap-2">
                                <Shield className="h-5 w-5 text-[#DB2B30]" />
                                Security Settings
                            </CardTitle>
                            <CardDescription>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex-1 space-y-1">
                                    <div className="flex items-center gap-2">
                                        ...
                                        {is2FAEnabled ? (
                                            <ShieldCheck className="h-4 w-4 text-[#DB2B30]" />
                                        ) : (
                    ...
                    <Card className="border border-[#DB2B30]/40">
                        <CardHeader>
                            <CardTitle className="flex items-center gap-2">
                                <Palette className="h-5 w-5 text-[#DB2B30]" />
                                Appearance
                            </CardTitle>
                            <CardDescription>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex-1 space-y-1">
                                    <div className="flex items-center gap-2">
                                        ...
                                        {mounted && (
                                            isDarkMode ? (
                                                <Moon className="h-4 w-4 text-[#FDEBEB]" />
                                            ) : (
                                                <Sun className="h-4 w-4 text-[#DB2B30]" />
                                            )
                                        )}
                                    </div>
                                    <p className="text-sm text-muted-foreground">
                    ...
                    {/* AI Chat Settings moved to tone sheets */}
                </div>
            </div>
        </RequireAuth>
    );
